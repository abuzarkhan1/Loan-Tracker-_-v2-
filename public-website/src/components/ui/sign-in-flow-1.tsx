...
function MiniNavbar() {
  ...
  const loginButtonElement = (
    <Link to="/sign-in" className="px-4 py-2 sm:px-3 text-xs sm:text-sm border border-[#333] bg-[rgba(31,31,31,0.62)] text-gray-300 rounded-full hover:border-white/50 hover:text-white transition-colors duration-200 w-full sm:w-auto text-center">
      LogIn
    </Link>
  );
  ...
  const signupButtonElement = (
    <div className="relative group w-full sm:w-auto">
       ...
       <Link to="/sign-in" className="relative z-10 block text-center px-4 py-2 sm:px-3 text-xs sm:text-sm font-semibold text-black bg-gradient-to-br from-gray-100 to-gray-300 rounded-full hover:from-gray-200 hover:to-gray-400 transition-all duration-200 w-full sm:w-auto">
         Signup
       </Link>
    </div>
  );
    ...
    <header className={`fixed top-6 left-1/2 transform -translate-x-1/2 z-20
      ...
      <div className={`sm:hidden flex flex-col items-center w-full transition-all ease-in-out duration-300 overflow-hidden
        ...
        <nav className="flex flex-col items-center space-y-4 text-base w-full">
          {navLinksData.map((link) => (
            <Link key={link.href} to={link.href} className="text-gray-300 hover:text-white transition-colors w-full text-center">
              {link.label}
            </Link>
          ))}
        </nav>
              ...
              <AnimatePresence mode="wait">
                {step === "email" ? (
                            ...
                            <div key={i} className="flex items-center">
                              <div className="relative">
                                <input
                                  ...
                                  className="w-8 text-center text-xl bg-transparent text-white border-none focus:outline-none focus:ring-0 appearance-none animate-none"
                  ...
                  >
                    ...
                    <Link to="/" className="block text-center w-full rounded-full bg-white text-black font-medium py-3 hover:bg-white/90 transition-colors">
